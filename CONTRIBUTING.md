...
4. Run `./scripts/container-e2e.sh` when packaging, security configuration, or
   the HTTP workflow changes.
5. Explain the business behavior and architectural impact in the pull request.
